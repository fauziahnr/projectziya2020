...
class Transaksi extends CI_Controller {
	...
	public function filter(){
		...
		if ($filters == 1 ) {
			$pelapakatas 	= $this->header_transaksi_model->pelapakatas();

			$data 	= array( 'title'	=> 'Data Transaksi',
							'pelapakatas'	=> $pelapakatas,
							'isi'	=> 'admin/transaksi/pelapakatas'
						);
			$this->load->view('admin/layout/wrapper', $data, FALSE);

		}elseif ($filters == 2) {
			$pelangganatas 	= $this->header_transaksi_model->pelangganatas();

			$data 	= array( 'title'	=> 'Data Transaksi',
							'pelangganatas'	=> $pelangganatas,
							'isi'	=> 'admin/transaksi/pelangganatas'
						);
			$this->load->view('admin/layout/wrapper', $data, FALSE);
		}else{
			$header_transaksi 	= $this->header_transaksi_model->listing();
