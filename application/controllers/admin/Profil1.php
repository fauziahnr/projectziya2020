...
// data produk
	...
	public function foto($id_user)
	{
		...
		if($valid->run()) {
			...
			//End Validasi
		$data = array ('title'	=>	'Tambah Gambar Profil'.$produk->nama_produk,
						'produk' => $produk,
						'gambar' => $gambar,
...
$this->image_lib->resize();
	...
	public function tambah()
	{
		...
		$valid->set_rules('nama_produk','Nama Profil','required', array( 'required'	=> '%s harus diisi' ));

		$valid->set_rules('kode_produk','Kode Profil','required|is_unique[produk.kode_produk]', array( 'required'		=> '%s harus diisi', 
...
$this->image_lib->resize();
	...
	public function edit($id_produk)
	{
		...
		$valid->set_rules('kode_produk','Kode Profil','required', array( 'required'		=> '%s harus diisi'));
		...
		if($valid->run()) {
			...
			//End Validasi
		$data = array ('title'	=>	'Edit Profil: '.$produk->nama_produk,
						'kategori' => $kategori,
						'produk'	=> $produk,
						'error'	=> $this->upload->display_errors(),
...
/* Location: ./applicfation/controllers/admin/Profil.php */