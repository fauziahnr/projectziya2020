          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              ?>
                      ...
                      <div class="form-group has-feedback">
                        <input type="password" name="password2" class="form-control" placeholder="Enter your confirm password">
                        <span class="glyphicon glyphicon-mail form-control-feedback"></span>
                      </div>

                      <button type="submit" name="Submit" class="btn btn-warning btn-lg btn-block">Reset Password</button>
