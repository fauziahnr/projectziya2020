...
<div class="form-group form-group-lg">
  ...
  <div class="col-md-8">
    <input type="text" name="namaweb" class="form-control"  placeholder="Nama Website" value="Female Preneur App" required>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    ...
    Icon lama: <br> 
    <img src="<?php echo base_url('assets/upload/image/logo-icon.png') ?>" class="img img-responsive img-thumbnail" width="200">
  </div>
</div>
