...
<div class="form-group form-group-lg">
  ...
  <div class="col-md-8">
    <input type="text" name="nama_produk" class="form-control"  placeholder="Nama Produk" value="<?php echo $produk->nama_produk ?>" readonly>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="number" name="harga" class="form-control"  placeholder="Harga Produk" value="<?php echo $produk->harga ?>" readonly>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="number" name="stok" class="form-control"  placeholder="Stok Produk" value="<?php echo $produk->stok ?>" readonly>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="berat" class="form-control"  placeholder="Berat Produk" value="<?php echo $produk->berat ?>" readonly>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="ukuran" class="form-control"  placeholder="Ukuran Produk" value="<?php echo $produk->ukuran ?>" readonly>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-10">
    <textarea name="keterangan" class="form-control" placeholder="Keterangan" id="editor" readonly><?php echo $produk->keterangan  ?></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-10">
    <textarea name="keywords" class="form-control" placeholder="Keyword (untuk SEO Google)" readonly><?php echo $produk->keywords  ?></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-10">
  <img src="<?php echo base_url('assets/upload/image/thumbs/'.$produk->gambar) ?>" class="img img-responsive img-thumbnail" width="200">
  </div>
</div>
