...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="password" class="form-control"  placeholder="Password" value="<?php echo $user->password ?>" readonly>
  </div>
</div>

<div class="form-group">
  <label class="col-md-2 control-label">Ubah Foto Profil</label>
 ...
 Foto lama: <br> 
    <img src="<?php echo base_url('assets/upload/image/'.$user->foto) ?>" class="img img-responsive img-thumbnail" width="200">
  </div>
</div>
