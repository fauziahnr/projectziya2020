	...
	<!-- <section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(<?php echo base_url() ?>assets/template/images/Untitled-1.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 w-size1 animated visible-false" data-appear="zoomIn">
							...
							<a href="<?php echo base_url() ?>assets/template/product.html" class="flex-c-m size2 bo-rad-23 s-text2 bgwhite hov1 trans-0-4">
								Sewa Now
							</a>
						</div>
					</div>
