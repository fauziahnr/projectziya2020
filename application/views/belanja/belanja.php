	...
	<div class="container">
		...
		<div class="container-table-cart pos-relative">
			<div class="wrap-table-shopping-cart bgwhite">
				...
				<h1>Data Gabung Pelaku Usaha</h1>
				...
				<table class="table-shopping-cart">
					<tr class="table-head">
						...
						<th class="column-3">JUMLAH BARANG</th>
						<!-- <th class="column-5 p-l-70">LAMA</th> -->
				...
				<p class="pull-right">
					...
					<a href="<?php echo base_url('belanja/hapus') ?>" class="btn btn-danger btn-lg">
						<i class="fa fa-trash-o"></i> Hapus Data Gabung
					</a>

					<a href="<?php echo base_url('belanja/checkout') ?>" class="btn btn-success btn-lg">
						<i class="fa fa-shopping-cart"></i> Gabung Sekarang
					</a>
