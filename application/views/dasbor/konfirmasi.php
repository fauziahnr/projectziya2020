				...
				if($header_transaksi) {
				 ...
				 <table class="table table-bordered">
				 	...
				 	<tbody>
				 		...
				 		<!-- <tr>
				 			<td>ID</td>
				 			<td>: <?php echo $header_transaksi->id_pelapak?></td>
				 		</tr> -->
				 		<tr>
				 			<td>Bukti Bayar</td>
				  ...
				  <table class="table">
				  	<tbody>
				  		<tr>
				  			...
				  			<td>
				  				<!-- <input type="" name="" value="<?php echo $header_transaksi->id_pelapak ?>"> -->
				  				<select name="id_rekening" class="form-control">
									...
									?>
				  					...
				  					<option > 
				  						<?php if($rekening->id_pelapak==$header_transaksi->id_pelapak) {?>
				  		...
				  		<tr>
				  			...
				  			<td>
				  				<input type="text" name="rekening_pembayaran" class="form-control" value="<?php echo $header_transaksi->rekening_pembayaran ?>" placeholder="Rekening Pembayaran">
